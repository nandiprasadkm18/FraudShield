...
class PDFService:
    def generate_report_pdf(self, threat_id: str, analysis: dict) -> bytes:
        ...
        now_dt = datetime.now(ist).strftime("%d %b %Y, %H:%M IST")
        
        c.setFont("Times-Bold", 10)
        c.drawString(50, 110, "Generated:")
        c.setFont("Times-Roman", 10)
        c.drawString(50, 95, now_dt)
        
        c.setFont("Times-Bold", 10)
        c.drawString(50, 75, "Generated By:")
        c.setFont("Times-Roman", 10)
        c.drawString(50, 60, "FraudShield AI Investigation Engine")
        ...
        c.setFont("Courier", 8)
        c.drawString(50, 40, f"SHA-256 Digital Footprint: {footprint}")
