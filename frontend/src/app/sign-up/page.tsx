...
export default function SignUpPage() {
  return (
    <div className="flex min-h-screen bg-[#050505] text-white font-sans">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  type="text" 
                  className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#34d399] transition-colors"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  type="tel" 
                  className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-[#34d399] transition-colors font-mono tracking-wider"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  type="password" 
                  className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl pl-10 pr-10 py-2.5 text-sm text-white focus:outline-none focus:border-[#34d399] transition-colors"
            ...
            <button 
              type="submit"
              className="w-full bg-white text-black font-bold py-3.5 rounded-xl hover:bg-zinc-200 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.2)] mt-6 text-sm flex items-center justify-center gap-2"
            >
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-gradient-to-bl from-[#052e16] via-[#022c22] to-[#050505] p-12 border-l border-[#10b981]/10">
